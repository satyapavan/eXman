...
const TX_CATEGORY_ICONS = [
    ...
    '<i class="icon-tx-category mx-1 my-1 icon-transport fas fa-motorcycle"></i>'        , // Transport
    ...
    '<i class="icon-tx-category mx-1 my-1 icon-outstation fas fa-bus-alt"></i>', // Outstation 
    '<i class="icon-tx-category mx-1 my-1 icon-clothing fas fa-tshirt"></i>'     , // Clothing
    '<i class="icon-tx-category mx-1 my-1 icon-office fas fa-desktop"></i>'  , // Office
